...
function Contact() {
  ...
  try {
    ...
    console.log("Contact function error:", error);

    // ============================================
    // SUPABASE RESOURCE LIMIT
    // ============================================
    //
    // The SMTP email has already been delivered to
    // Zoho before this error occurs.
    //
    // Therefore treat this particular response
    // as successful on the frontend.
    //
    ...
    if (
      ...
      console.warn(
        "Email was submitted. Supabase returned a non-2xx response after processing."
      );
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-300 px-5 py-4 focus:border-pink-500 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed"
              />
              ...
              <textarea
                ...
                disabled={isSubmitting}
                className="w-full rounded-xl border border-gray-300 px-5 py-4 resize-none focus:border-pink-500 focus:outline-none disabled:bg-gray-100 disabled:cursor-not-allowed"
              />
              ...
              {successMessage && (
                <div className="rounded-xl bg-green-50 border border-green-200 px-5 py-4 text-green-700">
                  {successMessage}
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full rounded-xl bg-pink-600 py-4 font-semibold text-white hover:bg-pink-700 transition disabled:bg-pink-400 disabled:cursor-not-allowed"
              >
